  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          <el-col :span="6" class="table-cell"><el-input v-model="order.receiverName" ></el-input></el-col>
          <el-col :span="6" class="table-cell"><el-input v-model="order.receiverPhone" ></el-input></el-col>
          <el-col :span="12" class="table-cell"><el-input v-model="order.receiverAddress" ></el-input></el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
      ...
      <el-table
        ...
        <el-table-column label="归属人" width="120" align="center">
        ...
        <el-table-column label="售出价" width="120" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.productSallPrice}}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="小计" width="120" align="center">
          <template slot-scope="scope">
            ￥{{scope.row.productSallPrice*scope.row.productQuantity}}
          </template>
        </el-table-column>
      </el-table>
